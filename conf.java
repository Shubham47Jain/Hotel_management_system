...
public class conf extends javax.swing.JFrame {
    public conf(String st1,String st2,int ck) {
    initComponents();
    String dt="\n\n";
    dt+="      User ID  :  "+st1;
    if(ck==1)dt+="\n\n     Password  :  "+st2;
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("E:\\Documents\\Govind Java Programs\\Project\\hotel\\Image\\close.png")); // NOI18N
        ...
        t.setEditable(false);
        t.setColumns(20);
        t.setFont(new java.awt.Font("Consolas", 0, 18)); // NOI18N
        t.setLineWrap(true);
        t.setRows(5);
        t.setBorder(null);
