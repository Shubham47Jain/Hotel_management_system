...
public emp(JPanel a1,JPanel a2,JPanel a3,reception abc,admin p,String xyz) {
        initComponents();
        lp=a1;
        hp=a2;
        rp=a3;
    ...
    private void j4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_j4MouseClicked
        ...
        rp.setVisible(true);
        p2.setVisible(true);
        obj.head.setText("Remove Employee");
